...
def test_GpxElem___repr__(args, result):
...
def test_GpxElem___str__(args, result):
...
def test_GpxMeta_togpx(bounds, result):
...
def test_Waypoints_import_locations():
...
def test_Waypoints_export_gpx_file():
    with open("tests/data/gpx") as f:
...
def test_Trackpoint___repr__(args, result):
    assert Trackpoint(*args) == result


def test_Trackpoints_import_locations():
...
def test_Trackpoints_export_gpx_file():
    with open("tests/data/gpx_tracks") as f:
...
def test_Routepoint__repr__(args, result):
    assert Routepoint(*args) == result


def test_Routepoints_import_locations():
...
def test_Routepoints_export_gpx_file():
    with open("tests/data/gpx_routes") as f:
